...
@Module({
  imports: [TypeOrmModule.forFeature([AssignedMenuRole]), RolesModule, forwardRef(() => MenuModule) , UsersModule, CacheManagerModule],
  controllers: [AssignedMenuRoleController],
  providers: [AssignedMenuRoleService],
  exports: [AssignedMenuRoleService, TypeOrmModule],
})
