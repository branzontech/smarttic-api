...
export class TableTicket1744888387856 implements MigrationInterface {
    name = 'TableTicket1744888387856'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Tickets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" text, "ticketStateId" uuid, "ticketTitleId" uuid, "state" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid, CONSTRAINT "PK_6533595a87a7d0e3b7ed082b2aa" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "TickeDetails" ADD CONSTRAINT "FK_cb3c09be4a7f7da652087863cc6" FOREIGN KEY ("ticketId") REFERENCES "Tickets"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "TickeDetails" DROP CONSTRAINT "FK_cb3c09be4a7f7da652087863cc6"`);
